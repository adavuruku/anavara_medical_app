...
urlpatterns = [
    ...
    path('get/<int:medical_record_id>', RetrieveAUserMedicalRecord.as_view(), name='get_a_user_medical_record'),
    path('get/all/<str:hospital_id>', RetrieveAUserAllMedicalRecord.as_view(), name='retrieve_patients_record'),
]